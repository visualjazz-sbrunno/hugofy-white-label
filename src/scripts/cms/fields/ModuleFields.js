    ...
    types: [
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            name: "our_board_exec_description",
            widget: "markdown",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            label: "Description",
            name: "friends_cmhaa_description",
            widget: "markdown",
            default: "CMHAA is guided by a group of mental health experts from across Australia. We call this group the Friends of CMHAA:",
          },
          {
            label: "Friends",
            name: "friend",
            widget: "list",
            allow_add: true,
            fields: [{ label: "Our friend", name: "friend_text", widget: "string" }],
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            widget: "list",
            allow_add: true,
            fields: [{ label: "Image", name: "gallery_image", widget: "image" }],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        fields: [
          {
            label: "Intro",
            name: "feat_member_intro",
            widget: "string",
            default: "Hear from some of our members and get to know their story.",
            required: true,
          },
          {
      ...
      },
      {
        ...
        widget: "object",
        fields: [{ label: "Heading", name: "heading", widget: "string", required: false }],
      },
    ],
  },
];
